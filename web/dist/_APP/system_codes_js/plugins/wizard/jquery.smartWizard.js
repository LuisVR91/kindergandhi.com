...
function SmartWizard(target, options) {
    ...
    this.buttons = {
        finish  : $('<button >'+options.labelFinish+'</button>').attr("type","submit").addClass("btn btn-system"),
        previous : $('<a>'+options.labelPrevious+'</a>').attr("href","#").addClass("btn btn-default"),
        next : $('<a>'+options.labelNext+'</a>').attr("href","#").addClass("btn btn-default")
    };
...
// Default Properties and Events
    $.fn.smartWizard.defaults = {
        ...
        includeFinishButton : null   // Add the finish button
    };
