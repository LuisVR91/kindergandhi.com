...
<img src="prueba-editada_n.jpg" alt="">
<img src="prueba-editada_gal.jpg" alt="">
<!--
...
$file = "$nombre.jpg";
$ext = "jpg";
$fileNewName = "prueba-editada";
$sourceProperties = getimagesize("$nombre.jpg");
...
switch ($imageType) {
    case IMAGETYPE_PNG:
        ...
        $targetLayer = cuadrada(50,$imageResourceId,$sourceProperties[0],$sourceProperties[1]);
        imagepng($targetLayer,$folderPath. $fileNewName. "_car.". $ext, 0);

        $targetLayer = cuadrada(500,$imageResourceId,$sourceProperties[0],$sourceProperties[1]);
        imagepng($targetLayer,$folderPath. $fileNewName. "_gal.". $ext, 0);
    ...
    case IMAGETYPE_GIF:
        ...
        $targetLayer = cuadrada($yx,$imageResourceId,$sourceProperties[0],$sourceProperties[1]);
        imagegif($targetLayer,$folderPath. $fileNewName. "_car.". $ext);
        break;
        ...
        $targetLayer = cortar(1200,600, $imageResourceId,$sourceProperties[0],$sourceProperties[1]);
        imagejpeg($targetLayer,$folderPath. $fileNewName. "_n.". $ext, 100);



       
        $targetLayer = cuadrada(50,$imageResourceId,$sourceProperties[0],$sourceProperties[1]);
        imagejpeg($targetLayer,$folderPath. $fileNewName. "_car.". $ext, 100);

        $targetLayer = cuadrada(500,$imageResourceId,$sourceProperties[0],$sourceProperties[1]);
        imagejpeg($targetLayer,$folderPath. $fileNewName. "_gal.". $ext, 100);
